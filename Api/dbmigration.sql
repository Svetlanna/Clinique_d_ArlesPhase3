CREATE DATABASE  IF NOT EXISTS `cliniquearles` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cliniquearles`;
-- MySQL dump 10.13  Distrib 8.0.36, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: cliniquearles
-- ------------------------------------------------------
...
CREATE TABLE `utilisateur` (
  ...
  `role` enum('admin','medecin','operateur') NOT NULL,
  `actif` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`),
...
INSERT INTO `utilisateur` VALUES (1,'admin_arles@gmail.com','azerty','admin',1),(2,'medecin_arles@gmail.com','azerty','medecin',1),(3,'operateur_arles@gmail.com','azerty','operateur',1);
...
CREATE TABLE `utilisateurs` (
  ...
  `role` enum('admin','medecin','infirmier','etl','reporting') COLLATE utf8mb4_unicode_ci NOT NULL,
  `actif` tinyint(1) NOT NULL DEFAULT '1',
  `date_creation` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_utilisateur`),
  UNIQUE KEY `uq_login` (`login`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Comptes utilisateurs de la clinique Arles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `utilisateurs` VALUES (1,NULL,'admin','Admin@1234','admin',1,'2023-01-15 08:00:00'),(2,1,'t.estri','Mdp@1234','medecin',1,'2023-02-01 09:00:00'),(3,2,'i.faure','Mdp@1234','medecin',1,'2023-02-01 09:15:00'),(4,3,'k.nakamura','Mdp@1234','medecin',1,'2023-02-03 10:00:00'),(5,4,'s.bencherif','Mdp@1234','medecin',1,'2023-02-03 10:20:00'),(6,5,'l.garnier','Mdp@1234','medecin',1,'2023-02-05 11:00:00'),(7,6,'c.moreau','Mdp@1234','medecin',1,'2023-02-05 11:30:00'),(8,7,'m.dupuis','Mdp@1234','medecin',1,'2023-02-07 14:00:00'),(9,8,'n.roux','Mdp@1234','infirmier',1,'2023-03-01 08:30:00'),(10,9,'s.martin','Mdp@1234','infirmier',1,'2023-03-01 08:45:00'),(11,10,'c.bernard','Mdp@1234','infirmier',1,'2023-03-02 09:00:00'),(12,11,'a.petit','Mdp@1234','infirmier',1,'2023-03-02 09:20:00'),(13,12,'m.leroy','Mdp@1234','infirmier',1,'2023-03-05 10:00:00'),(14,13,'j.simon','Mdp@1234','infirmier',1,'2023-03-05 10:30:00'),(15,14,'f.michel','Mdp@1234','infirmier',1,'2023-03-07 11:00:00'),(16,15,'a.lefebvre','Mdp@1234','infirmier',1,'2023-03-07 11:20:00'),(17,NULL,'etl_service','Etl@1234','etl',1,'2023-01-15 08:05:00'),(18,NULL,'reporting','Report@1234','reporting',1,'2023-01-15 08:10:00');
/*!40000 ALTER TABLE `utilisateurs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `v_dernier_suivi`
--

DROP TABLE IF EXISTS `v_dernier_suivi`;
/*!50001 DROP VIEW IF EXISTS `v_dernier_suivi`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_dernier_suivi` AS SELECT 
 1 AS `patient`,
 1 AS `medecin`,
 1 AS `date_suivi`,
 1 AS `poids`,
 1 AS `imc`,
 1 AS `tension_systolique`,
 1 AS `tension_diastolique`,
 1 AS `statut_tabac`,
 1 AS `notes_evolution`,
 1 AS `statut_patient`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_derniers_event_respi`
--

DROP TABLE IF EXISTS `v_derniers_event_respi`;
/*!50001 DROP VIEW IF EXISTS `v_derniers_event_respi`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_derniers_event_respi` AS SELECT 
 1 AS `id_evenement`,
 1 AS `id_nuit`,
 1 AS `type_evenement`,
 1 AS `debut_sec`,
...
--
-- Temporary view structure for view `v_nuit_etude`
--

DROP TABLE IF EXISTS `v_nuit_etude`;
/*!50001 DROP VIEW IF EXISTS `v_nuit_etude`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_nuit_etude` AS SELECT 
 1 AS `nom_superviseur`,
 1 AS `nom_medecin`,
 1 AS `nom_patient`,
 1 AS `date_nuit`,
 1 AS `type_etude`,
 ...
 1 AS `equipement`,
 1 AS `motif_prescription`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_profil_utilisateur`
--

DROP TABLE IF EXISTS `v_profil_utilisateur`;
/*!50001 DROP VIEW IF EXISTS `v_profil_utilisateur`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_profil_utilisateur` AS SELECT 
 1 AS `nom`,
 1 AS `login`,
 1 AS `mot_de_passe`,
 1 AS `role`,
...
--
-- Temporary view structure for view `v_resultat_nuit`
--

DROP TABLE IF EXISTS `v_resultat_nuit`;
/*!50001 DROP VIEW IF EXISTS `v_resultat_nuit`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_resultat_nuit` AS SELECT 
 1 AS `nom_superviseur`,
 1 AS `nom_medecin`,
 1 AS `nom_patient`,
 1 AS `date_nuit`,
...
--
-- Dumping events for database 'cliniquearles'
--

--
-- Dumping routines for database 'cliniquearles'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_compteur_all` */;
...
BEGIN
    SELECT COUNT(*) AS nb_evenement_respiratoire
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_compteur_apnees` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    SELECT COUNT(*) AS nb_evenement_respiratoire_apnee
    FROM evenement_respiratoire
    WHERE type_evenement LIKE 'apnÃ©e obstructive'
       OR type_evenement LIKE 'apnÃ©e centrale';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_compteur_hypopnae` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    SELECT COUNT(*) AS nb_evenement_respiratoire_hypopnee
    FROM evenement_respiratoire
    WHERE type_evenement LIKE 'hypopnÃ©e';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_compteur_rera` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    SELECT COUNT(*) AS nb_evenement_respiratoire_rera
    FROM evenement_respiratoire
    WHERE type_evenement LIKE 'RERA';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_consultations_par_patient` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consultations_par_patient`(idPatient INTEGER)
BEGIN
	SELECT 
		CONCAT(patient.prenom,' ',patient.nom) AS patient,
		CONCAT(personnel.prenom,' ',personnel.nom) AS medecin,
		date_consultation, motif, compte_rendu
	FROM consultation
	LEFT JOIN patient ON consultation.id_patient = patient.id_patient
	LEFT JOIN personnel ON consultation.id_medecin = personnel.id_personnel
	WHERE consultation.id_patient = idPatient;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_info_medicale_patient` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_info_medicale_patient`(idPatient INTEGER)
BEGIN
	SELECT
	id_patient, nom, prenom, 
	...
	pa_tabac, consommation_alcool, profession, niveau_activite, date_creation_dpi, 
    		case patient.actif
			when 1 then 'oui'
			when 0 then 'non'
		end as actif
...
BEGIN
    ...
    -- Une seule requÃªte qui rassemble tout ce dont le rapport
    -- a besoin : identitÃ© patient, infos nuit, et rÃ©sultat complet.
    -- Le rapport Python n'a donc qu'un seul appel Ã  faire,
    -- pas de jointures Ã  gÃ©rer cÃ´tÃ© Python.
    SELECT
        -- IdentitÃ© patient
        p.id_patient,
        p.nom,
...
--
-- Final view structure for view `v_dernier_suivi`
--
...
/*!50001 VIEW `v_dernier_suivi` AS select concat(`patient`.`prenom`,' ',`patient`.`nom`) AS `patient`,concat(`personnel`.`prenom`,' ',`personnel`.`nom`) AS `medecin`,`suivi_patient`.`date_suivi` AS `date_suivi`,`suivi_patient`.`poids` AS `poids`,`suivi_patient`.`imc` AS `imc`,`suivi_patient`.`tension_systolique` AS `tension_systolique`,`suivi_patient`.`tension_diastolique` AS `tension_diastolique`,`suivi_patient`.`statut_tabac` AS `statut_tabac`,`suivi_patient`.`notes_evolution` AS `notes_evolution`,`suivi_patient`.`statut_patient` AS `statut_patient` from ((`suivi_patient` left join `patient` on((`suivi_patient`.`id_patient` = `patient`.`id_patient`))) left join `personnel` on((`suivi_patient`.`id_medecin` = `personnel`.`id_personnel`))) order by `suivi_patient`.`id_suivi` desc limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_derniers_event_respi`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_derniers_event_respi` AS select `evenement_respiratoire`.`id_evenement` AS `id_evenement`,`evenement_respiratoire`.`id_nuit` AS `id_nuit`,`evenement_respiratoire`.`type_evenement` AS `type_evenement`,`evenement_respiratoire`.`debut_sec` AS `debut_sec`,`evenement_respiratoire`.`fin_sec` AS `fin_sec`,`evenement_respiratoire`.`duree_sec` AS `duree_sec`,`evenement_respiratoire`.`severite` AS `severite`,`evenement_respiratoire`.`decibels` AS `decibels`,`evenement_respiratoire`.`spo2_avant` AS `spo2_avant`,`evenement_respiratoire`.`spo2_apres` AS `spo2_apres` from `evenement_respiratoire` order by `evenement_respiratoire`.`id_evenement` desc limit 10 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_nuit_etude`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_nuit_etude` AS select concat(`superviseur`.`prenom`,' ',`superviseur`.`nom`) AS `nom_superviseur`,concat(`medecin`.`prenom`,' ',`medecin`.`nom`) AS `nom_medecin`,concat(`patient`.`prenom`,' ',`patient`.`nom`) AS `nom_patient`,`ne`.`date_nuit` AS `date_nuit`,`ne`.`type_etude` AS `type_etude`,`ne`.`notes_techniques` AS `notes_techniques`,`appareil_psg`.`type_montage` AS `equipement`,`prescription_nuit`.`motif_prescription` AS `motif_prescription` from (((((`nuit_etude` `ne` left join `patient` on((`ne`.`id_patient` = `patient`.`id_patient`))) left join `personnel` `superviseur` on((`ne`.`id_superviseur` = `superviseur`.`id_personnel`))) left join `personnel` `medecin` on((`ne`.`id_medecin` = `medecin`.`id_personnel`))) left join `appareil_psg` on((`ne`.`id_appareil_psg` = `appareil_psg`.`id_appareil`))) left join `prescription_nuit` on((`ne`.`id_nuit` = `prescription_nuit`.`id_nuit`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_profil_utilisateur`
--
...
--
-- Final view structure for view `v_resultat_nuit`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_resultat_nuit` AS select concat(`superviseur`.`prenom`,' ',`superviseur`.`nom`) AS `nom_superviseur`,concat(`medecin`.`prenom`,' ',`medecin`.`nom`) AS `nom_medecin`,concat(`patient`.`prenom`,' ',`patient`.`nom`) AS `nom_patient`,`ne`.`date_nuit` AS `date_nuit`,`ne`.`type_etude` AS `type_etude`,`ne`.`notes_techniques` AS `notes_techniques`,`appareil_psg`.`type_montage` AS `equipement`,`prescription_nuit`.`motif_prescription` AS `motif_prescription` from (((((`nuit_etude` `ne` left join `patient` on((`ne`.`id_patient` = `patient`.`id_patient`))) left join `personnel` `superviseur` on((`ne`.`id_superviseur` = `superviseur`.`id_personnel`))) left join `personnel` `medecin` on((`ne`.`id_medecin` = `medecin`.`id_personnel`))) left join `appareil_psg` on((`ne`.`id_appareil_psg` = `appareil_psg`.`id_appareil`))) left join `prescription_nuit` on((`ne`.`id_nuit` = `prescription_nuit`.`id_nuit`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-07-01 10:08:26
